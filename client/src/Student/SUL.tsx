...
const ApplyLeavePage = () => {
  ...
  const handleApplyLeave = () => {
    ...
    const apiUrl = `http://localhost:8000/api/v1/leave/${leaveID}`;
  ...
  return (
    <div>
      ...
      <form>
        <label>
          Leave ID:
          <input type="number" value={leaveID} onChange={handleLeaveIDChange} />
        </label>
        <label>
          Leave Type:
          <input
